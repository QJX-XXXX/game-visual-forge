...
5. Keep raw candidates and source audio immutable. Process into a separate staging directory, validate 44,100 Hz, 16-bit signed PCM WAV delivery, and record SHA-256 hashes, waveform, spectrum, loop evidence, and protected-region evidence. Normalize eligible generated text-to-audio one-shots to a deterministic -1.0 dBFS PCM peak; never apply that gain stage to raw files or source-preserving modes.
